INSERT INTO `import_export_profile` (`id`, `name`, `system_default`, `source_entity`, `file_type`, `delimiter`, `enclosure`, `mapping`, `created_at`, `updated_at`, `config`)
VALUES
(UNHEX('c2fab5123d634fbb9f5f3d79cbdf7974'), 'Produkte', 0, 'product', 'text/csv', ';', '"', '[
   {
      "key":"active",
      "mappedKey":"active"
   },
